...
def parse_args():
    ...
    parser.add_argument("-s", "--steps", dest="eval_steps", type=int, default=1000)
    parser.add_argument("-v", "--viz", dest="viz", type=bool, default=False, help="Whether to ")
    parser.add_argument(
        "-r",
        "--rate",
        dest="rate",
...
def eval():
    ...
    vis = Vis()
    while True:
        all_states, des_traj = rollout_adaptive_policy(
            eval_steps,
            adaptation_network,
            policy,
            evalenv,
